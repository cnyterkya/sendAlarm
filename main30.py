...
logging.basicConfig(filename="log_file30.log", level=logging.DEBUG, format='%(asctime)s %(message)s', filemode='w')
...
def trading_strategy(symbol):
  ...
  klines = client.get_klines(symbol=symbol, interval=Client.KLINE_INTERVAL_30MINUTE)
